...
export default function ChatGroup(){
  ...
  useEffect(()=>{
  axios.get('https://641bfe561f5d999a446e82cc.mockapi.io/api/users').then(res=>{
  setUsers(res.data);
  })
},[]);
console.log(users);
...
async function handleSubmit(e){
  ...
  await axios.post('https://641bfe561f5d999a446e82cc.mockapi.io/api/users', NewData).then(()=>{
    users.push(NewData);
    setUsers([...users]);
  })
  setFormData({text:" "})
      ...
      <div class=" box-primary direct-chat direct-chat-primary">
        <div class="box-header with-border">
          <ul className="head-arrow">
            ...
            <h3 class="box-title">109220-Naturalization</h3>
